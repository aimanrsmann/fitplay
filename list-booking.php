            ...
            <div class="mt-8 bg-white mx-10 rounded-2xl h-[900px] shadow-lg border border-gray-300">
                <div class="border-b border-gray-200 px-4 py-5 sm:px-6">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h2 class="text-2xl font-bold tracking-tight text-gray-900">List of Booking</h2>
                        </div>
                    </div>
                </div>
                ...
                <table class="min-w-[1500px] bg-white shadow-md mx-10 mt-5 rounded-lg">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT B.BookingID, U.email, S.SportName, B.Date, B.Time, B.Status 
                            FROM Booking B 
                                ...
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6">
                                        <?php if ($row['Status'] === 'Pending'): ?>
                                            <form id="approve-form-<?php echo $row['BookingID']; ?>" method="POST" style="display:inline;">
                                                ...
                                                <button type="button" class="bg-blue-500 text-white px-4 py-2 rounded"
                                                    onclick="confirmApprove(<?php echo $row['BookingID']; ?>)">Approve</button>
                                            </form>

                                            <form id="reject-form-<?php echo $row['BookingID']; ?>" method="POST" style="display:inline;">
                                                <input type="hidden" name="booking_id" value="<?php echo $row['BookingID']; ?>">
                                                <input type="hidden" name="reject_booking" value="1">
                                                <button type="button" class="bg-red-500 text-white px-4 py-2 rounded"
                                                    onclick="confirmReject(<?php echo $row['BookingID']; ?>)">Reject</button>
                                            </form>
                                        <?php else: ?>
                                            <!-- No action for other statuses (Approved/Rejected) -->
